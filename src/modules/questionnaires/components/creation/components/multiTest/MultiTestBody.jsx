...
const MultiTestBody = ({ optionsMultiTest, setOptionsMultiTest, setQuestionValue }) => {
  return (
    <>
      <div className="row" style={{ marginTop: "20px" }}>
        <div className="col-6">
          ...
          <button
            ...
            disabled={optionsMultiTest.length >= 6}
        ...
        <div className="col-4">
          <label className="form-label form-question-title">Opción correcta (al menos una)</label>
        </div>
      </div>
      {optionsMultiTest.map((q, index) => {
        return (
              ...
              <div className="form-check">
                <input
                  ...
                  onClick={() => {
                    ...
                    setOptionsMultiTest((oldOptions) => {
                      let aux = [...oldOptions];
                      let auxValue = { ...oldOptions[index] };
                      auxValue.correct = !auxValue.correct;
                      aux[index] = auxValue;
                      return aux;
                    });
                  }}
