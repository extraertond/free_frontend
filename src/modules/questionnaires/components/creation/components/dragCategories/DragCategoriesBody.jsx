...
const DragCategoriesBody = ({ setQuestionValue, dragCategories, setDragCategories }) => {
  ...
  const addCategory = () => {
    ...
    setDragCategories((oldCategories) => {
      ...
      auxCategories.push({
        ...
        deletable: true,
        titleErrored: false,
        options: [{ option_id: 0, text: "", deletable: true, errored: false }],
      });
      _countOptions(auxCategories);
      return auxCategories;
    });
        ...
        return (
          <div key={index} className="row" style={{ marginTop: "10px" }}>
            ...
            <div className="col-7">
              <div className="row">
                <div className="col">
                  <label className="form-label form-question-title">Opciones (Entre 0 y 4)</label>
                </div>
              </div>
              {q.options.map((o, i) => {
                return (
...
export default DragCategoriesBody;
