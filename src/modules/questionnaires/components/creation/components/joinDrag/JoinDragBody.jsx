...
const JoinDragBody = ({ setQuestionValue, joinDrag, setJoinDrag }) => {
        ...
        return (
          <div key={index} className="row" style={{ marginTop: "10px" }}>
            <div className="col-5" style={{ display: "flex", flexDirection: "column" }}>
              <label className="form-label form-question-title">{`Opción ${index + 1}`}</label>
              <input
                type="text"
            ...
            <div className="col-5" style={{ display: "flex", flexDirection: "column" }}>
              ...
              <input
                ...
                placeholder="Destino de la opción..."
